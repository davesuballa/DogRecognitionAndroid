...
class CustomSpinnerAdapter(context: Context, resource: Int, objects: List<String>) :
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        return createViewFromResource(inflater, position, convertView, parent, R.layout.spinner_item)
    }
    ...
    private fun createViewFromResource(
        ...
        textView.setTextColor(ContextCompat.getColor(context, R.color.graybreed))
        return view
    }
}
