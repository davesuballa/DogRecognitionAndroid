...
// Activity
class dog_avatar_creation2 : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dog_avatar_creation2)
        ...
        {
            val gretriever = findViewById<TextView>(R.id.gretriever)
            gretriever.setBackgroundResource(R.drawable.golden1)
        }
        ...
        doneButton.setOnClickListener {
            val alertDialogBuilder = AlertDialog.Builder(this@dog_avatar_creation2)
            ...
            alertDialogBuilder.setPositiveButton("Confirm") { dialog, _ ->
                Toast.makeText(this@dog_avatar_creation2, "Dog Avatar has been changed.", Toast.LENGTH_SHORT).show()
                updateUserDetails(selectedBreed, selectedFurColor, selectedAccessory, dogId)
                val intent = Intent(this@dog_avatar_creation2, homepageold::class.java)
            ...
            alertDialogBuilder.setNegativeButton("Cancel") { dialog, _ ->
                Toast.makeText(this@dog_avatar_creation2, "Changing Dog Avatar is cancelled", Toast.LENGTH_LONG).show()
                dialog.dismiss()
            }
    ...
    private fun updateUserDetails(
        ...
        selectedFurColor: String,
        selectedAccessory: String?,
        dogId: String  // Add dogId as a parameter
    ) {
        // Check if any of the parameters are null or empty
        if (selectedBreed.isNullOrEmpty() || selectedFurColor.isNullOrEmpty()) {
            Toast.makeText(this, "Please select breed and fur color.", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        if (currentUserID != null) {
            ...
            val userDogsRef = userRef.child("Dogs").child(dogId)  // Use the provided dogId
            ...
            // Update the user's details for the selected dog
            userDogsRef.updateChildren(updates)
                .addOnSuccessListener {
                }
                .addOnFailureListener {
                    Toast.makeText(this, "Failed to change your Dog Avatar.", Toast.LENGTH_SHORT).show()
                }
        } else {
    ...
    private fun showExitConfirmationDialog() {
        ...
        alertDialogBuilder.setMessage("Are you sure you want to skip changing the avatar for your dog? You won't be able to return to your progress and your dog avatar will not show but you can edit your dog avatar later. \n\nYou will proceed to Homepage if you confirm.")
        alertDialogBuilder.setPositiveButton("Confirm") { dialog, _ ->
